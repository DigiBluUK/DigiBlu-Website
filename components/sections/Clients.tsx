          ...
          <div className="clients-viewport">
            <div className="clients-track">
              <ul className="clients-group">
                ...
                <li><span className="client-logo cl-tpx" role="img" aria-label="TPx"></span></li>
                <li><span className="client-logo cl-spamedica" role="img" aria-label="SpaMedica"></span></li>
                <li><span className="client-logo cl-ppl" role="img" aria-label="PPL: People Places Lives"></span></li>
                <li><span className="client-logo cl-agria" role="img" aria-label="Agria Pet Insurance"></span></li>
                <li><span className="client-logo cl-soc" role="img" aria-label="Special Olympics Canada"></span></li>
                <li><span className="client-logo cl-oneadvanced" role="img" aria-label="OneAdvanced"></span></li>
                <li><span className="client-logo cl-ema" role="img" aria-label="Ema"></span></li>
                <li><span className="client-logo cl-safari" role="img" aria-label="Safari Destinations"></span></li>
              </ul>
              <ul className="clients-group" aria-hidden="true">
                ...
                <li><span className="client-logo cl-tpx"></span></li>
                <li><span className="client-logo cl-spamedica"></span></li>
                <li><span className="client-logo cl-ppl"></span></li>
                <li><span className="client-logo cl-agria"></span></li>
                <li><span className="client-logo cl-soc"></span></li>
                <li><span className="client-logo cl-oneadvanced"></span></li>
                <li><span className="client-logo cl-ema"></span></li>
                <li><span className="client-logo cl-safari"></span></li>
              </ul>
            </div>
          </div>
        </section>
