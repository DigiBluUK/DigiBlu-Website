...
- **Pages and dialogs**: every service, case study, bio, accreditation, legal document and the contact form has its own prerendered page. The home page also opens them in dialogs, over real links, as progressive enhancement (DigiBlu's "Option A", 11 Sep 2026). **Radu asked on 18 Sep for the dialogs to go**; that decision is DigiBlu's and pending.
